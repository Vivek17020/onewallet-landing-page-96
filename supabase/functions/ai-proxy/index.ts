  ...
  try {
    ...
    switch (task) {
      ...
      case 'format-seo-content':
        try {
          const prompt = `You are an SEO content editor and optimization expert. Format this content into a well-structured, SEO-optimized article.

CRITICAL SEO REQUIREMENTS:
1. KEYWORD OPTIMIZATION:
   - Extract primary keyword from title (2-4 word phrase)
   - Include primary keyword in FIRST PARAGRAPH (first 100 words)
...
2. HEADING STRUCTURE (MUST FOLLOW):
   - Use H2 for main sections (create 4-6 H2 tags minimum)
...
3. CONTENT REQUIREMENTS:
   ...
   - Minimum 800 words (expand if needed)
   - Add keyword variations naturally throughout
   - Include semantic keywords related to topic

ALLOWED HTML TAGS ONLY:
- Headings: <h2>, <h3>, <h4>
- Text: <p>, <strong>, <em>, <u>
- Lists: <ul>, <ol>, <li>
- Links: <a href="[internal-link-placeholder]">keyword</a>
- Images: <div class="image-placeholder" data-topic="topic"></div>
- Other: <blockquote>, <code>, <pre>, <hr>

DO NOT USE: HTML comments, script tags, iframe, or any tags not listed above

STRUCTURE TEMPLATE:
<div class="image-placeholder" data-topic="hero_image"></div>

<p>[First paragraph with PRIMARY KEYWORD]...</p>

<h2>[Main Topic with PRIMARY KEYWORD]</h2>
<p>...</p>

<h2>[Related Topic with KEYWORD VARIATION]</h2>
<p>...</p>

<div class="image-placeholder" data-topic="relevant_topic"></div>

<h2>Frequently Asked Questions</h2>
<h3>How [question with keyword]?</h3>
<p>...</p>

<h3>What [question with keyword variation]?</h3>
<p>...</p>
...
Humanized HTML (no code fences):`
      ...
      case 'seo-optimize':
        try {
          const seoPrompt = `Analyze and optimize this article for better search engine rankings.

OPTIMIZATION REQUIREMENTS:
1. KEYWORD PLACEMENT:
   - Ensure primary keyword (from title) appears in first 100 words
   - Include primary keyword in 60%+ of H2 headings
   - Add keyword variations naturally throughout
   - Maintain 3-5% keyword density

2. LSI KEYWORDS:
   - Add semantic keywords related to main topic
...
3. STRUCTURE:
   ...
   - Optimize subheadings for featured snippets
...
6. Return ONLY the optimized HTML
