...
export default async function handler(req, res) {
  ...
  try {
    ...
    // NOTE: UPSC sitemap temporarily removed until sufficient content is available (AdSense protection)
    const sitemaps = [
      { loc: `${baseUrl}/sitemap.xml`, lastmod: today },
      { loc: `${baseUrl}/web3-sitemap.xml`, lastmod: today },
      // { loc: `${baseUrl}/upsc-sitemap.xml`, lastmod: today }, // Re-enable when UPSC has 20+ articles
