...
export default function CompressPdf() {
  ...
  const compressPdf = useCallback(async () => {
    ...
    try {
      ...
      const compressionSettings = {
        ...
        medium: { useObjectStreams: true, objectsPerTick: 50 },
        low: { useObjectStreams: false, objectsPerTick: 100 },
      };
    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "File size reduction varies by document type and content. Text-heavy PDFs can be compressed by 30-70%, while image-heavy PDFs may see 10-40% reduction. Higher compression levels provide more size reduction."
        }
      },
      {
        "@type": "Question",
        "name": "Is my file stored?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "No, your files are never stored or uploaded. All compression happens locally in your browser. Your PDF remains completely private and secure on your device."
        }
      },
      {
        "@type": "Question",
        "name": "Will image quality drop?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Our compression maintains high quality for both scanned and text PDFs. We optimize file structure without degrading images or text, ensuring your document remains clear and professional."
        }
      }
    ]
  };
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <Helmet>
        <title>Compress PDF Online – Reduce File Size Free | TheBulletinBriefs</title>
        <meta
          name="description"
          content="Shrink PDF file size without losing quality. 100% secure and free. Choose compression level for optimal results."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://thebulletinbriefs.in/tools/compress-pdf/" />
        
        <meta property="og:title" content="Compress PDF Online – Reduce File Size Free | TheBulletinBriefs" />
        <meta property="og:description" content="Shrink PDF file size without losing quality. 100% secure and free." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://thebulletinbriefs.in/tools/compress-pdf/" />
        
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Compress PDF Online – Reduce File Size Free | TheBulletinBriefs" />
        <meta name="twitter:description" content="Shrink PDF file size without losing quality. 100% secure and free." />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Easily reduce your PDF size to share faster without compromising clarity.
            </p>
          </div>
              ...
              {pdfFile && !compressionResult && (
                <div className="space-y-4">
                  ...
                  <div className="space-y-3 p-4 border border-border rounded-lg bg-card">
                    <Label className="text-sm font-semibold">Choose Compression Level</Label>
                    <RadioGroup value={compressionLevel} onValueChange={(value) => setCompressionLevel(value as CompressionLevel)}>
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="high" className="cursor-pointer">
                          High Compression <span className="text-xs text-muted-foreground">(Smallest file size)</span>
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="medium" id="medium" />
                        <Label htmlFor="medium" className="cursor-pointer">
                          Medium Compression <span className="text-xs text-muted-foreground">(Balanced)</span>
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="low" id="low" />
                        <Label htmlFor="low" className="cursor-pointer">
                          Low Compression <span className="text-xs text-muted-foreground">(Best quality)</span>
                        </Label>
                      </div>
                    </RadioGroup>
                  </div>
            ...
            <div className="space-y-6">
              <div className="border-b border-border pb-6">
                ...
                <p className="text-muted-foreground">
                  File size reduction varies by document type and content. Text-heavy PDFs can be compressed by 30-70%, while image-heavy PDFs may see 10-40% reduction. Higher compression levels provide more size reduction.
                </p>
              </div>
              
              <div className="border-b border-border pb-6">
                <h3 className="text-xl font-semibold mb-2">Is my file stored?</h3>
                <p className="text-muted-foreground">
                  No, your files are never stored or uploaded. All compression happens locally in your browser. Your PDF remains completely private and secure on your device.
                </p>
              </div>
              
              <div className="border-b border-border pb-6 last:border-0">
                <h3 className="text-xl font-semibold mb-2">Will image quality drop?</h3>
                <p className="text-muted-foreground">
                  Our compression maintains high quality for both scanned and text PDFs. We optimize file structure without degrading images or text, ensuring your document remains clear and professional.
                </p>
              </div>
            </div>
          </section>
