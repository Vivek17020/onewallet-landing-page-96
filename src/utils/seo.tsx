...
// Generate Organization structured data for homepage - Education focused
export function generateOrganizationStructuredData() {
  ...
  return {
    ...
    description: "India's leading student news platform for UPSC preparation, government job notifications, education news, exam results, scholarship updates, and career guidance for students and job aspirants.",
    foundingDate: "2024",
    address: {
      "@type": "PostalAddress",
      addressCountry: "IN",
