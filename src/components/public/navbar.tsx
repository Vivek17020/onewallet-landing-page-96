      ...
      <div className="container flex h-16 items-center">
        <div className="mr-4 hidden md:flex">
          <Link to="/" className="mr-6 flex items-center space-x-2">
            ...
            <div className="flex flex-col">
              <span className="font-bold text-xl bg-gradient-primary bg-clip-text text-transparent leading-tight">
                TheBulletinBriefs
              </span>
              <span className="text-[10px] text-muted-foreground font-medium tracking-wide">
                India's Student News Portal
              </span>
            </div>
          </Link>
        ...
        >
          ...
          <div className="flex flex-col items-start">
            <span className="font-bold text-lg bg-gradient-primary bg-clip-text text-transparent leading-tight">
              TheBulletinBriefs
            </span>
